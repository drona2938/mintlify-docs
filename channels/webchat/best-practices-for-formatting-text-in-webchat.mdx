---
title: "Best Practices for Formatting Text in Webchat"
---
...
You can use the following guidelines to format your text in Fliqr AI’s webchat. Please remember to use both conversation examples and instructions to follow the show-and-tell method, which demonstrates proper formatting through clear examples alongside explanations.
...
| ----------------------- | --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| CSS Reset for Width     | Ensures all elements stay within the parent container's width, useful for landing pages and email in CBB. |                                                                                                                                         |
