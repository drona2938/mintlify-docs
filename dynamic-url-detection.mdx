...
|---------------------------|--------------------------------------------------|----------------------------------------------------|---------------------------------------------|
| Default Setup             | Inline `<script>` with `ktt10.setup`            | `https://app.fliqr.ai/webchat/plugin.js?v=6` | Automatically sets `{{webchat_parent_url}}` |
| Advanced / Dynamic        | Dynamically load `<script>` in JavaScript       | `https://app.fliqr.ai/webchat/plugin.js?v=6&parent=encoded_url` | Must encode `window.location.href` manually  |
| Iframe Embedding          | `<iframe>` with src set to Fliqr AI URL | `https://app.fliqr.ai/webchat/?v=6&parent=encoded_url` | Pass parent in the query string              |
