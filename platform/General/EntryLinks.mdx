...
To enable your users to refer friends, your bot needs to provide each user with a unique link. Let's say your Entry Point Link is named 'EXAMPLE1.' To create a unique link for the referral system, simply add `--Fliqr AI{{user_id}}` to the end of any Entry Point Link.

For example:
`https://m.me/FB_PAGE_ID?ref=EXAMPLE1--Fliqr AI{{user_id}}`
